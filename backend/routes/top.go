...
func GetDemand(c *gin.Context) {
	items, err := database.GetTopCategory("buy_volume", constants.BazaarTopDemandQuota)
	if err != nil {
...
func GetMargin(c *gin.Context) {
	items, err := database.GetTopCategory("margin", constants.BazaarTopMarginQuota)
	if err != nil {
...
func GetMarginPercent(c *gin.Context) {
	items, err := database.GetTopCategory("margin_percent", constants.BazaarTopMarginPercentQuota)
	if err != nil {
